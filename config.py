...
API_ID = int(os.environ.get("API_ID", "39784550"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "c25dfad085ed2c6d1ef05a0eb585eeda")

# Your Owner / Admin Id For Broadcast 
ADMINS = int(os.environ.get("ADMINS", "8245397481"))
...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://nikhilsharma4799_db_user:2iPVRsvjyhQQyxOS@cluster0.jtuajg5.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
